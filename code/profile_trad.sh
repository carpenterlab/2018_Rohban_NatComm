...
parallel -j 1 './profile_trad.R --name=2015_10_05_DrugRepurposing_AravindSubramanian_GolubLab_Broad --batch=2016_04_01_a549_48hr_batch1 --plate={1} --feats="../input/feature_list.txt" --operation="median+mad" --col="Metadata_broad_sample" --value="DMSO" --cores=2' :::: '../input/processed_plates_repurposing.txt'