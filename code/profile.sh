...
parallel -j 1 './profile.R --name=2015_Bray_GigaScience --batch=CDRP --plate={1} --dim=3000 --rdensity=0.1 --core=2 --col=Metadata_broad_sample --value=DMSO --feats="../input/feature_list.txt"' :::: ../input/processed_plates_CDRP_bio.txt
