...
'compare_mean_cov_filteredMoA
Usage:
compare_mean_cov_filteredMoA -p <perturbation_type>
Options:
...
cr.melt.mean$Metadata_moa.x <- str_to_lower(cr.melt.mean$Metadata_moa.x)
cr.melt.mean$Metadata_moa.y <- str_to_lower(cr.melt.mean$Metadata_moa.y)
cr.melt.cov$Metadata_moa.x <- str_to_lower(cr.melt.cov$Metadata_moa.x)
cr.melt.cov$Metadata_moa.y <- str_to_lower(cr.melt.cov$Metadata_moa.y)
cr.melt.mad$Metadata_moa.x <- str_to_lower(cr.melt.mad$Metadata_moa.x)
cr.melt.mad$Metadata_moa.y <- str_to_lower(cr.melt.mad$Metadata_moa.y)
cr.melt.median.mad.2$Metadata_moa.x <- str_to_lower(cr.melt.median.mad.2$Metadata_moa.x)
cr.melt.median.mad.2$Metadata_moa.y <- str_to_lower(cr.melt.median.mad.2$Metadata_moa.y)
FA.cr.melt.mean$Metadata_moa.x <- str_to_lower(FA.cr.melt.mean$Metadata_moa.x)
FA.cr.melt.mean$Metadata_moa.y <- str_to_lower(FA.cr.melt.mean$Metadata_moa.y)
FA.cr.melt.median$Metadata_moa.x <- str_to_lower(FA.cr.melt.median$Metadata_moa.x)
FA.cr.melt.median$Metadata_moa.y <- str_to_lower(FA.cr.melt.median$Metadata_moa.y)
FA.cr.melt.mad$Metadata_moa.x <- str_to_lower(FA.cr.melt.mad$Metadata_moa.x)
FA.cr.melt.mad$Metadata_moa.y <- str_to_lower(FA.cr.melt.mad$Metadata_moa.y)
pc.cr.melt.mean$Metadata_moa.x <- str_to_lower(pc.cr.melt.mean$Metadata_moa.x)
pc.cr.melt.mean$Metadata_moa.y <- str_to_lower(pc.cr.melt.mean$Metadata_moa.y)
pc.cr.melt.median$Metadata_moa.x <- str_to_lower(pc.cr.melt.median$Metadata_moa.x)
pc.cr.melt.median$Metadata_moa.y <- str_to_lower(pc.cr.melt.median$Metadata_moa.y)
pc.cr.melt.mad$Metadata_moa.x <- str_to_lower(pc.cr.melt.mad$Metadata_moa.x)
pc.cr.melt.mad$Metadata_moa.y <- str_to_lower(pc.cr.melt.mad$Metadata_moa.y)
#dp.cr.melt.mean$Metadata_moa.y <- str_to_lower(dp.cr.melt.mean$Metadata_moa.y)

moa_to_keep <-
 cr.melt.mean %>%
  filter(Metadata_moa.x == Metadata_moa.y) %>%
  select(Metadata_moa.x) %>%
  group_by(Metadata_moa.x) %>%
  tally() %>%
  arrange(desc(n)) %>%
  filter(n > 5) %>%
  select(-n) %>%
  rename(Metadata_moa = Metadata_moa.x)

remove_moa_with_few_pairs <- function(cr.melt){
  cr.melt %>%
    inner_join(moa_to_keep, by = c("Metadata_moa.x" = "Metadata_moa")) %>%
    inner_join(moa_to_keep, by = c("Metadata_moa.y" = "Metadata_moa"))
}

cr.melt.mean <- cr.melt.mean %>% remove_moa_with_few_pairs()
cr.melt.cov <- cr.melt.cov %>% remove_moa_with_few_pairs()
cr.melt.mad <- cr.melt.mad %>% remove_moa_with_few_pairs()
cr.melt.median.mad.2 <- cr.melt.median.mad.2 %>% remove_moa_with_few_pairs() 
FA.cr.melt.mean <- FA.cr.melt.mean %>% remove_moa_with_few_pairs()
FA.cr.melt.median <- FA.cr.melt.median %>% remove_moa_with_few_pairs() 
FA.cr.melt.mad <- FA.cr.melt.mad %>% remove_moa_with_few_pairs()
pc.cr.melt.mean <- pc.cr.melt.mean %>% remove_moa_with_few_pairs()
pc.cr.melt.median <- pc.cr.melt.median %>% remove_moa_with_few_pairs()
pc.cr.melt.mad <- pc.cr.melt.mad %>% remove_moa_with_few_pairs() 
#dp.cr.melt.mean %>% remove_moa_with_few_pairs()
...
#d <- apply(dp.cr.mean, 1, function(x) !(sum(is.na(x)) >= (NROW(pc.cr.mean) -1 )))
...
g <- ggplot(D, aes(x = top.prec, y = odds.ratio, color = method, order = method)) + 
  ...
  theme(legend.title=element_blank())
print(g) 
ggsave("global_comparison_filteredMoA.png", g, width = 7, height = 5)
